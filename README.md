...
1. TorchicTab Installation

    ```bash
    git clone https://gitlab.kuleuven.be/dtai/kg/code/SemTab/semtabr1-wikidata.git (TODO: Replace with open source Github repo)
    pip install -e . 
    python3 download_spacy.py
    ```

2. AutoRML installation (current repository)
